...
#define HDMI_WUINT32(offset,value)  writel(value, (void*)(HDMI_BASE + offset))
#define HDMI_RUINT32(offset)        readl((void*)(HDMI_BASE + offset))
#define HDMI_WUINT16(offset,value)  writew(value, (void*)(HDMI_BASE + offset))
#define HDMI_RUINT16(offset)        readw((void*)(HDMI_BASE + offset))
#define HDMI_WUINT8(offset,value)   writeb(value, (void*)(HDMI_BASE + offset))
#define HDMI_RUINT8(offset)         readb((void*)(HDMI_BASE + offset))
