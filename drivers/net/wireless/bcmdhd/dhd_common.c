...
dhd_common_init(osl_t *osh)
{
	...
	if (select_type == 3 || select_type == 4) {
		bcm_strncpy_s(fw_path, sizeof(fw_path), "/lib/firmware/ap6330/fw_bcm40181a2.bin", MOD_PARAM_PATHLEN-1);
	}	
	//select ap6330
	if (select_type == 5) {
		bcm_strncpy_s(fw_path, sizeof(fw_path), "/lib/firmware/ap6330/fw_bcm40183b2_ag.bin", MOD_PARAM_PATHLEN-1);
	}
    ...
    //select ap6181
	if (select_type == 3) {
		bcm_strncpy_s(nv_path, sizeof(nv_path), "/lib/firmware/ap6330/nvram_ap6181.txt", MOD_PARAM_PATHLEN-1);
	}
	//select ap6210
	if (select_type == 4) {
		bcm_strncpy_s(nv_path, sizeof(nv_path), "/lib/firmware/ap6330/nvram_ap6210.txt", MOD_PARAM_PATHLEN-1);
	}	
	//select ap6330
	if (select_type == 5) {
		bcm_strncpy_s(nv_path, sizeof(nv_path), "/lib/firmware/ap6330/nvram_ap6330.txt", MOD_PARAM_PATHLEN-1);
	}
	...
	bcm_strncpy_s(conf_path, sizeof(conf_path), "/lib/firmware/ap6330/config.txt", MOD_PARAM_PATHLEN-1);
